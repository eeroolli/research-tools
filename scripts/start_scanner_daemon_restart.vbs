' ========================================
' Paper Processor Daemon - Manual Restart Launcher
' ========================================
' Use this manually before starting to scan
' Stops existing daemon (if running) and starts fresh

Set objShell = CreateObject("WScript.Shell")

' Show restart message
objShell.Popup "Restarting Paper Processor Daemon..." & vbCrLf & vbCrLf & _
              "This will:" & vbCrLf & _
              "  1. Stop existing daemon (if running)" & vbCrLf & _
              "  2. Start fresh daemon" & vbCrLf & vbCrLf & _
              ...
              10, "Paper Processor Daemon - Restart", 64

' Launch Windows Terminal with WSL and restart daemon
