#!/usr/bin/env python3
"""
Manual ISBN Metadata Search and Zotero Integration Script
...
class ManualISBNMetadataSearch:
    """Manual ISBN metadata search with enhanced Zotero integration"""
    ...
    def load_config(self):
        ...
        # Get data directory
        self.data_dir = Path(config.get('PATHS', 'data_folder', fallback='data'))
...
def main():
    """Main function"""
    try:
        processor = ManualISBNMetadataSearch()
        processor.main_menu()
